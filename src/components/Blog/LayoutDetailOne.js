                ...
                <div className="container">
                    <ul className="breadcrumb_nav flex items-center gap-1">
                        ...
                        <li className="flex items-center">
                            ...
                            <Link href="/blog/default" className="breadcrumb_link pl-1 caption1 duration-300 hover:underline">Blog</Link>
                        </li>
                        <li className="flex items-center">
                            <Icon.CaretRight className="text-xs opacity-50" />
                            <Link href="#!" scroll={false} className="breadcrumb_link pl-1 caption1 opacity-50 line-clamp-1 max-w-60">{data.title}</Link>
                        </li>
                    </ul>
                </div>
            </section>
            <section className="blog_detail sm:mt-15 mt-10">
                <div className="container flex max-lg:flex-col gap-y-12">
                    <div className="blog_content lg:pr-20">
                        <span className="blog_cate txt-label">{data.category}</span>
                        <h2 className="heading2 title mt-4">{data.title}</h2>
                        ...
                        <div className="w-full aspect-[16/9] md:mt-10 mt-7">
                    ...
                    <div className="blog_sidebar flex-shrink-0 lg:w-96 w-full h-fit">
                        <div className="author">
                            <div className="flex items-center gap-5">
                                <Image width={2000} height={2000} src="/images/team/team2.jpg" alt="Tony Nguyen" className="flex-shrink-0 w-[100px] h-[100px] rounded-full object-cover" />
                                <div>
                                    <h6 className="blog_author heading6">Tony Nguyen</h6>
                                    <span className="follower block mt-1 caption1 text-secondary">200 Follower</span>
                                    <button className="btn btn_outline mt-2">Follow</button>
                                </div>
                            </div>
                            <p className="desc text-secondary mt-5">Tony Nguyen (@tony.ng) is a writer who draws. She’s the Bestselling author of “Number of The Year”. Donec vitae tortor efficitur, convallis lelobortis elit.</p>
                            <ul className="flex flex-wrap items-center gap-3 mt-5">
                                <li>
                                    <Link href="https://www.messenger.com/" target="_blank" className="flex items-center justify-center w-10 h-10 border border-outline rounded-full duration-300 hover:bg-orange hover:text-white">
                                        <Icon.MessengerLogo className="text-xl" />
                                        <span className="blind">link messenger logo</span>
                                    </Link>
                                </li>
                                <li>
                                    <Link href="https://www.instagram.com/" target="_blank" className="flex items-center justify-center w-10 h-10 border border-outline rounded-full duration-300 hover:bg-orange hover:text-white">
                                        <Icon.InstagramLogo className="text-xl" />
                                        <span className="blind">link instagram logo</span>
                                    </Link>
                                </li>
                                <li>
                                    <Link href="https://www.x.com/" target="_blank" className="flex items-center justify-center w-10 h-10 border border-outline rounded-full duration-300 hover:bg-orange hover:text-white">
                                        <Icon.XLogo className="text-xl" />
                                        <span className="blind">link x logo</span>
                                    </Link>
                                </li>
                        ...
                        <BlogSidebar data={blogData} layout={'style-detail'} hideElements={'search category'} />
                    </div>
                </div>
            </section>
        </>
